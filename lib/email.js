    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api XyroBotz - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=62877717390538">WhatsApp</a></span></span>
      ...
      let mailOptions = {
        from: '"XyroBotzOTP" <xyrobotzotp@gmail.com>',
        to: email,
        subject: `Verify Email - Api XyroBotz`,
        html: inboxGmail,
      };
